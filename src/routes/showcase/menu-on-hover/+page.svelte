<script lang="ts">
  import { Menu, ButtonMilk } from "milk-lib";
...
<PageTitle>Menu. On Hover</PageTitle>
<Divider />
...
<div class="wrapper">
  ...
  >
		...
		<ButtonMilk onMouseEnter={mouseEnterHandler} variant="primary-emphasis" size="lg">{label}</ButtonMilk>
