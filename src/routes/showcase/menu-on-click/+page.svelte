<script lang="ts">
  import { Menu, MenuContent, MenuItem, MenuItemTitle, ButtonMilk } from "milk-lib";
  import { menuLinks } from './data';
  import { PageTitle, Divider } from '$lib';
...
<PageTitle>Menu. On click</PageTitle>
<Divider />
...
>
  ...
  <ButtonMilk onClick={mouseEnterHandler} variant="base-emphasis" size="lg">{label}</ButtonMilk>
